...
class UserCourseController extends Controller
{
   ...
   public function index($id){
        ...
        ->select('courses.id','courses.id as course_id','courses.daysofvalidity','courses.CourseName','courses.image','users.id','users.name as Usuario','users.email','users_courses.Video_actual as Video','users_courses.id as Vinculo' ,'users_courses.usuario_id', 'users_courses.status')
